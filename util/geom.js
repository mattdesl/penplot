...
export function expandTriangle (triangle, border = 0) {
...
export function resampleLineBySpacing (points, spacing = 1, closed = false) {
  if (spacing <= 0) {
...
export function cubicSpline (points, tension = 0.5, segments = 25, closed = false) {
